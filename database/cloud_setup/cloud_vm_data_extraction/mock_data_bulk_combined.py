"""
Combined bulk insert script for 3 months of daily mock data.
Each day inserts all rows from both the main and slow-changing tables.
...
# --- Main/metrics table insert functions ---
...
# --- Slow-changing table insert functions ---
