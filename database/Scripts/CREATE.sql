...
-- TO DO 01_create_tables.sql - Defines the application_logs table
...
-- TO DO 01_create_tables.sql - Defines the downtime_logs table
...
CREATE TABLE incident_response_logs (
    ...
    FOREIGN KEY (access_id) REFERENCES user_access_logs(access_id) ON DELETE SET NULL
);
